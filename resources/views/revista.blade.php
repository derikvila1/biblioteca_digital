...
<head>
  ...
  <title>Biblioteca Virtual do Amazonas - Revista Institucional </title>
  <link rel="stylesheet" type="text/css"
    href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.css">
  <link rel="stylesheet" type="text/css" href="css/css-revista-institucional.css">
...
<body>
  ...
  <div class="pusher">
    <div class="ui vertical masthead aligned segment">
      ...
      <div class="delimitacao-central-pagina">
        <div>
          <br><br><br>
          <h1 style="text-align: center;">Revista Institucional</h1>
        </div>
        <br>
        <div class="cards-content-line">
          <div class="ui link card" id="card-tema">
            <div class="content">
              ...
              <div class="header" style="text-align: center;">Amazônia<br> Internacional</div>
